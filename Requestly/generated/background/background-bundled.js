...
BG.Methods.registerListeners = function() {
  ...
  if (!chrome.webRequest.onHeadersReceived.hasListener(BG.Methods.modifyResponseHeadersListener)) {
    ...
    chrome.webRequest.onHeadersReceived.addListener(
      BG.Methods.modifyResponseHeadersListener, { urls: ['<all_urls>'] }, onHeadersReceivedOptions
    );
  }
};
...
BG.Methods.handleExtensionInstalledOrUpdated = function(details) {
  ...
  _gaq.push(['_trackEvent', RQ.GA_EVENTS.CATEGORIES.EXTENSION, details.reason, 'extension ' + details.reason + ' version: ' + chrome.runtime.getManifest().version]);
